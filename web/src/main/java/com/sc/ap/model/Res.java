...
public class Res extends BaseRes<Res> {
	...
	public List<Res> findResesByUserId(Integer userId) {
	...
	public List<Res> findSecResesByUserId(Integer userId, long rId) {
	...
	public Set<String> findAllResStrByUserId(Integer userId){
	...
	public Set<Res> findAllResByUserId(Integer userId){
